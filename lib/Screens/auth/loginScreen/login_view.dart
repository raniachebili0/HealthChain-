                  ...
                  child: Column(
                    children: [
                      ...
                      Align(
                        ...
                        child: InkWell(
                          onTap: () => Navigator.pushNamed(context, '/RestMDP'),
                          child: Text(
                            'Forgot your password?',
                            style: CustomTextStyle.h4.copyWith(fontSize: 12.sp),
                          ),
                        ),
                      ),
                      Spacer(),
                      ...
                      loginViewModel.isLoading
                          ...
                          : MyButton(
                              buttonFunction: () =>
                                  loginViewModel.login(context, formKeylogin),
                              buttonText: 'Login',
                            ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child:
                                Text('Sign up ', style: CustomTextStyle.lien),
                          ),
                        ],
                      ),
                    ],
